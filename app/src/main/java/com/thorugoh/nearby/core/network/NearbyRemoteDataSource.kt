package com.thorugoh.nearby.core.network

import com.thorugoh.nearby.core.network.KtorHttpClient.httpClientAndroid
import com.thorugoh.nearby.data.model.Category
import com.thorugoh.nearby.data.model.Coupon
import com.thorugoh.nearby.data.model.Market
import com.thorugoh.nearby.data.model.MarketDetails
...
object NearbyRemoteDataSource {
    ...
    private const val LOCAL_HOST_DEVICE_BASE_URL = "http://192.168.1.13:3333"
